const CACHE = 'zombie-hangman-web-v1088';
const FILES = [
  ...
  './assets/img/img_ratunek_v1088.png'
];
...
self.addEventListener('fetch', event => {
  ...
  const isFresh = isHtml || url.pathname.endsWith('.css') || url.pathname.endsWith('.js') || url.search.includes('v=1088');
