const CACHE='zombie-hangman-web-v1066';
...
self.addEventListener('fetch',e=>{
  ...
  const isFresh = url.pathname.endsWith('.html') || url.pathname.endsWith('.css') || url.pathname.endsWith('.js') || url.search.includes('v=1066');
  if(isFresh){
