...
function applyScale(){
  // v1042: skalowanie jest automatyczne w CSS osobno dla telefonu i komputera.
  // Nie używamy już starego ręcznego localStorage, bo powodowało za małe/za duże ekrany.
  menuScale = 1;
